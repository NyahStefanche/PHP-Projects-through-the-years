...
{
	include"db.php";
	$query = "INSERT INTO employee(pers_id,first,father,last,sex,b_day,city,street,phone)
...
<html>
<head>
	<title>Добавяне на служителя</title>
...
<div id="main">
	...
	<form method="POST" action="add_workers.php">
	<table border="1">
	<tr>
		<td>Име</td>
